...
public class VisionConstants {
    ...
    public final static String camera0name = "Arducam_OV9281_USB_Camera (2)"; //Left
    public final static String camera1name = "Arducam_OV9281_USB_Camera"; //Right
    public final static String camera2name = "Arducam_OV9281_USB_Camera (1)"; //Back
