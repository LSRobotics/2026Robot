...
public class TakeShotCommand extends Command {
    ...
    public static final class ShotData{
        ...
        public static final ShotSolution leftTrench = new ShotSolution(-1, RPM.convertFrom(48, RotationsPerSecond), 72);
        public static final ShotSolution rightTrench = new ShotSolution(-1, RPM.convertFrom(50, RotationsPerSecond), -80);
    }
}
